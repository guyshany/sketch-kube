  ...
  challenges: [
    {
          ...
          validations: [
            {
              ...
              operator: "exists",
              value: true,
              message: "Image needs a name (e.g., 'nginx' or 'myapp').",
            },
            {
              nodeType: "image",
              field: "tag",
      ...
      hints: [
        "Start with an Image node. Set the name to something like 'nginx' and tag to 'latest'.",
        "Add a Container, set its name and image field to match your Image (e.g., 'nginx:latest'). Connect Image → Container.",
