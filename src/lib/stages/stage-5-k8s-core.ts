  ...
  challenges: [
    {
      ...
      availableComponents: ["deployment", "service", "pod", "port"],
      testCases: [
        {
          id: "test-5-1",
      ...
      hints: [
        ...
        "Create a Service: set the same selector as the Deployment so it can find the pods. Set port to 80.",
        "Connect Deployment → Service with an edge.",
      ],
      maxStars: 3,
    },
  ],
